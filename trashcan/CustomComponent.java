...
class CustomComponents extends JComponent {
    ...
    public void paintComponent(Graphics g) {
        ...
        // create 20 blue or red circles each circle is smaller than the previous one
        for (int i = 0; i < 20; i++) {
            g.setColor(i % 2 == 0 ? Color.blue : Color.red);
            g.fillOval(margin + i * 10, margin + i * 10, dim.width - margin * 2 - i * 20, dim.height - margin * 2 - i * 20);
        }
    }
}